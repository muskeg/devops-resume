...
def index(request):
    ...
    content = {
        ...
        'section_project_title': section_project_title,
        'section_projects_intro': section_projects_intro,
